 ...
 * @author elduderino
 */
public class ResCountBlock extends TextBlock {

    ResBlock owner;
    Supplier<String> valueGetter;

    public ResCountBlock(ResBlock owner, Supplier<String> valueGetter) {
        this.owner = owner;
    ...
    public void update() {
        ...
        */
        ...
        rect = new Rectangle(owner.getRectangle().x, centrY, tb.width, tb.height);
    }
